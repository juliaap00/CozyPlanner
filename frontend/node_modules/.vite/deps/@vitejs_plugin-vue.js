  ...
  if (lang && /tsx?$/.test(lang) && !((_d = descriptor.script) == null ? void 0 : _d.src)) {
    const { code: code2, map } = await transformWithEsbuild(
      ...
      filename,
      {
        ...
        ...(_e = options.devServer) == null ? void 0 : _e.config.esbuild,
        loader: "ts",
        sourcemap: options.sourceMap
      },
      resolvedMap
  ...
  return {
    ...
    config(config) {
      ...
      return {
        ...
        define: {
          __VUE_OPTIONS_API__: !!((((_b = options.value.features) == null ? void 0 : _b.optionsAPI) ?? true) || ((_c = config.define) == null ? void 0 : _c.__VUE_OPTIONS_API__)),
          __VUE_PROD_DEVTOOLS__: !!(((_d = options.value.features) == null ? void 0 : _d.prodDevtools) || ((_e = config.define) == null ? void 0 : _e.__VUE_PROD_DEVTOOLS__)),
          __VUE_PROD_HYDRATION_MISMATCH_DETAILS__: !!(((_f = options.value.features) == null ? void 0 : _f.prodHydrationMismatchDetails) || ((_g = config.define) == null ? void 0 : _g.__VUE_PROD_HYDRATION_MISMATCH_DETAILS__))
        },
        ssr: {
